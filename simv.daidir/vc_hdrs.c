...
#ifndef __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_reset
#define __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_reset
__attribute__((weak)) void pcs_dpi_dut0_reset()
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)() = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)()) dlsym(RTLD_NEXT, "pcs_dpi_dut0_reset");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_();
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "pcs_dpi_dut0_reset");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_reset */

#ifndef __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_step
#define __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_step
__attribute__((weak)) unsigned int pcs_dpi_dut0_step(/* INPUT */unsigned int A_1, /* INPUT */unsigned int A_2)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static unsigned int (*_vcs_dpi_fp_)(/* INPUT */unsigned int A_1, /* INPUT */unsigned int A_2) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (unsigned int (*)(unsigned int A_1, unsigned int A_2)) dlsym(RTLD_NEXT, "pcs_dpi_dut0_step");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        return _vcs_dpi_fp_(A_1, A_2);
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "pcs_dpi_dut0_step");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_step */

#ifndef __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_step_debug
#define __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_step_debug
__attribute__((weak)) void pcs_dpi_dut0_step_debug(/* INPUT */unsigned int A_1, /* INPUT */unsigned int A_2, /* OUTPUT */unsigned int *A_3, /* OUTPUT */unsigned int *A_4, /* OUTPUT */unsigned int *A_5, /* OUTPUT */unsigned int *A_6, /* OUTPUT */unsigned int *A_7)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */unsigned int A_1, /* INPUT */unsigned int A_2, /* OUTPUT */unsigned int *A_3, /* OUTPUT */unsigned int *A_4, /* OUTPUT */unsigned int *A_5, /* OUTPUT */unsigned int *A_6, /* OUTPUT */unsigned int *A_7) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(unsigned int A_1, unsigned int A_2, unsigned int* A_3, unsigned int* A_4, unsigned int* A_5, unsigned int* A_6, unsigned int* A_7)) dlsym(RTLD_NEXT, "pcs_dpi_dut0_step_debug");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "pcs_dpi_dut0_step_debug");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_pcs_dpi_dut0_step_debug */
